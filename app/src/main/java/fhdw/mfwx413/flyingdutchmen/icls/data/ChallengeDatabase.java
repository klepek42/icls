...
public class ChallengeDatabase {
    ...
    public static ChallengeCollection getAllChallenges(){
        ...
        allChallenges.addChallenge(
                new Challenge(2, "Wie heißt der höchste Berg Europas", "Mont Blanc", "", "", 1, 1, allIndexCards.getIndexCard(0))
        );

        allChallenges.addChallenge(
                new Challenge(3, "Welches Musikfestival fand bis 2014 jährlich am Nürburgring statt?", "Rock am Ring", "", "", 1, 1, allIndexCards.getIndexCard(2))
        );
